...
// import Resume from '../assets/LAVANYA_SHARMAresume.pdf'
import {
...
export const NavBar = () => {
  ...
  const onUpdateActiveLink = (value) => {
    setActiveLink(value);
    if (value === 'resume') {
      window.open('/LAVANYA_SHARMAresume.pdf', "_blank");
    }
  }
        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ms-auto">
              ...
              <Nav.Link  className={activeLink === 'resume' ? 'active navbar-link' : 'navbar-link'} onClick={() => onUpdateActiveLink('resume')} target="_blank">Resume</Nav.Link>
            </Nav>
